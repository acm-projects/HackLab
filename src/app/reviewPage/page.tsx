...
//   const [roleIdNameMap, setRoleIdNameMap] = React.useState<{ [id: number]: string }>({});
...
//         <li key={index}>
//           {roleIdNameMap[id] ? roleIdNameMap[id] : `Role ID: ${id}`}
//         </li>
//       ))}
//     </ul>
//   </div>
...
export default function ReviewPage() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (createdProject?.github_repo_url) {
        console.log("GitHub repository created at:", createdProject.github_repo_url);
      } else {
        console.log("✅ Project created successfully, but no repository URL was returned.");
      }
