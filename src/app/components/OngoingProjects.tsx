...
const OngoingProjectCard: React.FC<OngoingProjectCardProps> = ({
  ...
  return (
    <div
      className="relative h-[450px] w-full rounded-[15px] border border-black bg-[#ffffff] overflow-hidden flex flex-col mb-[3px] cursor-pointer"
    ...
    >
      ...
      {/* Bottom Content */}
      <div className="h-[50%] w-full px-[15px] py-[10px] flex mt-[-5px] gap-[4px]">
        {/* Left Side */}
        <div className="flex flex-col w-2/3 pr-[8px] ml-[10px]">
          ...
          <div className="flex items-center gap-[6px] mt-[4px]">
            <p className="text-[13px] text-[#2e2e2e] absolute mt-[20px]">
              Led by: <span className="font-semibold">{groupLeader?.name || "Unknown"}</span>
            </p>
          </div>

          {/* Members */}
          <div className="absolute flex flex-col pb-[8px] mt-[110px]">
