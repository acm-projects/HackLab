   ...
   >
     ...
     <div className="h-[60%] w-full px-[15px] py-[10px] flex mt-[-10px] gap-[4px]">
       ...
       <div className="flex flex-col w-1/2 pr-[8px] ml-[10px]">
         ...
         <div className="mt-[-5px]">{skills.length > 0 && <TagRow items={skills} color="#5888b5" />}</div>


         {/* Group Leader */}
         <p className="text-[13px] text-[#2e2e2e] mt-[8px]">
         ...
         {/* Buttons */}
         <div className="absolute bottom-[16px] left-[16px] flex gap-[8px] z-10">
           <button
