...
const FindProjects = () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center bg-blue-900 text-white font-nunito overflow-y-auto">
      <NavBar/>
      <div className="grid grid-cols-2 gap-[50px] w-[85vw] mt-[150px] mx-auto">
        {projects.map((project, index) => (
          <div 
            key={index}
            className="transition-transform duration-300 hover:transform hover:-translate-y-[4px] hover:shadow-[0_10px_20px_rgba(0,0,0,0.2)]"
          >
            <OngoingProjectCard
              {...project}
              showJoinButton={true} 
